    ...
    >
      <div className="relative z-0 isolate flex w-full flex-1 scale-y-125 items-center justify-center">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 w-[30rem] overflow-visible bg-gradient-conic from-red-600 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-red-600 opacity-50 blur-3xl" />
        <motion.div
          initial={{ width: "8rem" }}
